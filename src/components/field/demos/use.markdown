...
export default function FormHorizontalDemo() {
	...
	return (
		<Form layout="horizontal" labelCol={{ span: 6 }} field={field}>
			<Form.Item label="用户名">
				<Input placeholder="请输入用户名" {...init('userName', {
					rules: [
			...
			<Form.Item label="邮箱">
				<Input placeholder="请输入验证邮箱" {...init('email', {
					rules: [
			...
			<Form.Item label="中奖次数">
				<InputNumber placeholder="请输入中奖次数" {...init('number', {
					rules: [
			...
			<Form.Item wrapperCol={{ offset: 6 }}>
				<Button type="primary" style={{ marginRight: 10 }} onClick={onValidate}>提交</Button>
