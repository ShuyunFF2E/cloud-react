...
class Grid extends Component {
  ...
  getTodayDisabled = () => {
    ...
    const minDateTimestamp = new Date(
      minYear,
      minMonth,
      minDay,
      '00',
    ...
    const maxDateTimestamp = new Date(
      maxYear,
      maxMonth,
      maxDay,
      '00',
    ...
    return (
      <div className="grid" style={style}>
        ...
        {showTimePicker && (
          <Time
            type="inner"
            onChange={this.onTimePickChange}
            value={`${tempHour}:${tempMinute}:${tempSecond}`}
          />
        )}
        ...
        <div className={`${selectorClass}-popup-btns`}>
          ...
          <Button
            type="primary"
            size="small"
            disabled={!tempDay || this.getOkButtonDisabled()}
            onClick={this.onSave}
          >
            确定
          </Button>
