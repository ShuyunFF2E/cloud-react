    ...
    render() {
        return (
            <Tabs defaultActiveKey="eat" onChange={this.handleChange} step={500}>
                ...
                <Tabs.Panel tab="选项1" key='11'>选项1111111111111</Tabs.Panel>
                <Tabs.Panel tab="吃饭" key="eat1">吃饭啊啊啊啊啊</Tabs.Panel>
                <Tabs.Panel tab="加关闭按钮" key="aaa1" closable>为什么要关掉我！</Tabs.Panel>
                <Tabs.Panel tab="禁用我？？" key="bbb1" disabled>试试</Tabs.Panel>
                <Tabs.Panel tab="选项1" key='12'>选项1111111111111</Tabs.Panel>
                <Tabs.Panel tab="吃饭" key="eat2">吃饭啊啊啊啊啊</Tabs.Panel>
                <Tabs.Panel tab="加关闭按钮" key="aaa2" closable>为什么要关掉我！</Tabs.Panel>
                <Tabs.Panel tab="禁用我？？" key="bbb2" disabled>试试</Tabs.Panel>
                <Tabs.Panel tab="选项1" key='13'>选项1111111111111</Tabs.Panel>
                <Tabs.Panel tab="吃饭" key="eat3">吃饭啊啊啊啊啊</Tabs.Panel>
                <Tabs.Panel tab="加关闭按钮" key="aaa3" closable>为什么要关掉我！</Tabs.Panel>
