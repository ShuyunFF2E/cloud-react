...
class DropdownDemo extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={style}>
        <Dropdown arrow overlay={overlay} placement="bottom">
          <Button type="normal">向下</Button>
        </Dropdown>
        <Dropdown arrow overlay={overlay} placement="bottomLeft">
          <Button type="normal">向左下</Button>
        </Dropdown>
        <Dropdown arrow overlay={overlay} placement="bottomRight">
          <Button type="normal">向右下</Button>
        </Dropdown>
        <Dropdown arrow overlay={overlay} placement="top">
          <Button type="normal">向上</Button>
        </Dropdown>
        <Dropdown arrow overlay={overlay} placement="topLeft">
          <Button type="normal">向左上</Button>
        </Dropdown>
        <Dropdown arrow overlay={overlay} placement="topRight">
