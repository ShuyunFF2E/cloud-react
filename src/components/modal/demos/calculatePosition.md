        ...
        ajaxData={(params) => {
          return new Promise(resolve => {
            setTimeout(() => {
              ...
              setTimeout(() => {
                document.querySelector('.cloud-modal-container').style.top = `${(document.querySelector('.cloud-modal-mask').offsetHeight - document.querySelector('.cloud-modal-container').offsetHeight) / 2}px`
              })
            }, 500)
          })
        }}
