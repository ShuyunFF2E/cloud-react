  ...
  render() {
    ...
    return (
      <Menu
        ...
        mode="horizontal"
        header={
          <img src="https://qa-pcrm.shuyun.com/pcrm/202102/e2f5f56627cbabf6e6790fe70503cefe/173253_54091_banner_syyj.jpg" />
        }
      >
        <Item key="2" icon={<Icon type="mail" />}>
          一级菜单
        </Item>
        ...
        <SubMenu title="四级菜单" key="4" icon={<Icon type="mail" />}>
