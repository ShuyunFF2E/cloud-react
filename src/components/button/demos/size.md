  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <h4>切换圆角</h4>
        <div style={{ marginBottom: 10 }}>
          <Button onClick={() => this.onChangeBorderRadius("default")}>
            默认-3px
          </Button>
          {blank}
          <Button onClick={() => this.onChangeBorderRadius("medium")}>
            medium-6px
          </Button>
          {blank}
          <Button onClick={() => this.onChangeBorderRadius("large")}>
            large-12px
          </Button>
          {blank}
          <Button onClick={() => this.onChangeBorderRadius("circle")}>
            circle-50%
          </Button>
        </div>
        ...
        <div>
          ...
          {blank}
          <Button type="dashed" size={size} borderRadiusSize={borderRadiusSize}>
            幽灵
          </Button>
          {blank}
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          <Button
            type="primary"
            icon={size === "small" ? undefined : "plus-solid"}
            size={size}
            borderRadiusSize={borderRadiusSize}
          >
            主要
