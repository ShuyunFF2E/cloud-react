		...
		return (
			<React.Fragment>
				<div>
					...
					{blank}
					<Button type="dashed" colorType="tips" >dashed-tips</Button>
					{blank}
					...
					{blank}
					<Button type="dashed" colorType="danger">dashed-danger</Button>
					{blank}
					...
					{blank}
					<Button type="dashed" colorType="success">dashed-success</Button>
					{blank}
