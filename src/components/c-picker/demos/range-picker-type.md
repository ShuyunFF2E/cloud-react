            ...
            presets={[
              {
                label: "前三周",
                value: () => [
                  moment().clone().subtract(3, "weeks").startOf("week"),
                  moment().clone().subtract(1, "weeks").startOf("week"),
                ],
              },
            ]}
          />
            ...
            presets={[
              {
                label: "Q1",
                value: () => [
                  moment().clone().month(0).startOf("month"),
                  moment().clone().month(2).endOf("month"),
                ],
              },
              {
                label: "Q2",
                value: () => [
                  moment().clone().month(3).startOf("month"),
                  moment().clone().month(5).endOf("month"),
                ],
              },
              {
                label: "Q3",
                value: () => [
                  moment().clone().month(6).startOf("month"),
                  moment().clone().month(8).endOf("month"),
                ],
              },
              {
                label: "Q4",
                value: () => [
                  moment().clone().month(9).startOf("month"),
                  moment().clone().month(11).endOf("month"),
                ],
              },
            ]}
          />
            ...
            presets={[
              {
                ...
                value: () => [
                  ...
                  moment().clone().quarter(2).endOf("quarter"),
                ],
              },
              {
                label: "下半年",
                value: () => [
                  moment().clone().quarter(3).startOf("quarter"),
            ...
            presets={[
              {
                label: "本世纪",
                value: () => [
                  moment().clone().year(2000).startOf("year"),
                  moment().clone().endOf("year"),
                ],
              },
              {
                label: "前 5 年",
                value: () => [
                  moment().clone().subtract(5, "years").startOf("quarter"),
                  moment().clone().subtract(1, "years").endOf("year"),
                ],
              },
            ]}
          />
