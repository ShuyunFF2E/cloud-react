...
describe('InputTag', () => {
	...
	it('should support clear tags', () => {
		const wrapper = mount(<InputTag data={['a', 'b']} />);
		const clearBtn = wrapper.find('.cloud-icon-close-circle-solid');
	...
	it('should support remove tag', () => {
		const wrapper = mount(<InputTag data={['a', 'b']} />);
		const closeBtn = wrapper.find('.cloud-input-tag-item .cloud-icon-close').at(0);
	...
	it('should support copy', () => {
		...
		const copyBtn = wrapper.find('.cloud-icon-remark');
