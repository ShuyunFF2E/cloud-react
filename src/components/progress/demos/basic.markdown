    ...
    render() {
		return (
			<div>
                ...
                <h4>条形进度条</h4>
                <span>small：</span><Progress type="line" size="small" percent={this.state.percent} />

                <div style={{ marginBottom: 10 }}/>

                <span>middle：</span><Progress type="line" showPercent size="middle" percent={this.state.percent} />

                <div style={{ marginBottom: 10 }}/>

                <span>large：</span><Progress type="line" color="#00b33c" showPercent size="large" percent={this.state.percent} />

                <div style={{ marginBottom: 10 }}/>

                <span>fail：</span><Progress type="line" size="large" color="#E74949" iconTpl={<Icon type="close-circle-solid"/>} percent={this.state.percent} />
