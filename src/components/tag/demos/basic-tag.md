  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div style={{ marginBottom: 15, fontSize: 14 }}>
          <Tag type="success" icon="success-fill">
            成功
          </Tag>
          <Tag type="danger" icon="close-fill-1">
            失败
          </Tag>
          <Tag type="warning" icon="no-start">
            未开始
          </Tag>
          <Tag type="default" icon="success-fill">
            已完成
          </Tag>
          <Tag color="blue" icon="underway">
            进行中
          </Tag>
        </div>
      </React.Fragment>
