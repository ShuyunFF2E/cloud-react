...
export default function PopoverDemo() {
  ...
  return (
    <div>
      ...
      {split}
      <Popover trigger={trigger} placement="right" content="这是一段文字描述">
        <Button>纯文字</Button>
      </Popover>
      {split}
      <Popover
        ...
        showCancelBtn
        showConfirmBtn
        content={<Input placeholder="请输入" style={{ width: 200 }} />}
      >
        <Button>带输入框</Button>
      </Popover>
      {split}
      ...
      {split}
      <Popover trigger={trigger} content="这是一段文字描述" showIcon>
