...
describe('TablePagination', () => {
  ...
  it('should support jump next page or preview page', () => {
    ...
    wrapper.find('.cloud-icon.icon-right-solid').simulate('click');
    expect(wrapper.state().current).toBe(2);

    wrapper.find('.cloud-icon.icon-left-solid').simulate('click');
  ...
  it('should support jump last page or first page', () => {
    const wrapper = mount(<Test />);
    wrapper.find('.cloud-icon.icon-last-solid').simulate('click');
    expect(wrapper.state().current).toBe(5);

    wrapper.find('.cloud-icon.icon-first-solid').simulate('click');
    expect(wrapper.state().current).toBe(1);
