...
// 通过文件夹名称生成组件名称
const toComponentsName = (text) => text
  .replace(/-\w/g, (str) => str.split('-')[1].toUpperCase())
  .replace(/^[A-Za-z]/, (str) => str.toLocaleUpperCase());
